<template>
    ...
    function getData() {
      const path = "http://127.0.0.1:5000/api/cloud/postinfo";
      axios
        .get(path)
        .then((res) => {
    ...
    function KDel(id, namespace, username) {
      axios
        .post(
          "http://127.0.0.1:5000/api/cloud/postdel",
          {
            id: id,
            namespace: namespace,
            username: username,
    ...
    function onDel(id, namespace, ldapUser, password) {
      axios
        .post(
          "http://127.0.0.1:5000/api/cloud/getinfo",
          {
            id: id,
            namespace: namespace,
            ldapUser: ldapUser,
      ...
      if (!searchInput.value) {
        ...
        return data.value.filter((item) => {
          ...
          return (
            ...
            item.projectid.toLowerCase().includes(searchInput.value.toLowerCase()) ||
